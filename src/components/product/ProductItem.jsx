...
const ProductItem = ({ product }) => {
  console.log(product, "ProductItem"); // Debugging
  
  return (
    
    <ProductCardWrapper to={`/product/details/${product.id}`}>
      ...
      <div className="product-info">
        ...
        <div className="flex items-center justify-between text-sm font-medium">
          ...
          <span className="text-outerspace font-bold">INR: {product.price}</span>
        </div>
      </div>
    </ProductCardWrapper>
  );
